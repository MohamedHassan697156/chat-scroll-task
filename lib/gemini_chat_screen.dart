...
import 'chat_stream_scroll_coordinator.dart';
...
class _GeminiChatScreenState extends State<GeminiChatScreen> {
  ...
  late final ChatStreamScrollCoordinator _streamScrollCoordinator;
  ...
  void initState() {
    ...
    _streamScrollCoordinator = ChatStreamScrollCoordinator(
  ...
  void _onStreamManagerChanged() {
    _streamScrollCoordinator.onStreamLayoutMayHaveChanged();
  }
    ...
    return Scaffold(
      ...
      body: NotificationListener<ScrollEndNotification>(
        onNotification: (notification) {
          _streamScrollCoordinator.onScrollEnd(notification);
          return false;
        },
        child: NotificationListener<ScrollUpdateNotification>(
          onNotification: (notification) {
            _streamScrollCoordinator.onScrollUpdate(notification);
            return false;
          },
          child: Listener(
            onPointerSignal: _streamScrollCoordinator.onPointerScroll,
  ...
  void _handleMessageSend(String text) async {
    _streamScrollCoordinator.userSentMessage();
